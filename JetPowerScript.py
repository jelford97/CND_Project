...
plt.ylabel('Jet Power (erg/s)')
plt.plot(mass,babyk,'--',color='black')
plt.savefig('TotalMassJetPower.png')
plt.close()
...
plt.savefig('JetPowerTotalMass.png')
plt.close()
