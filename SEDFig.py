...
def figure(p,k,M,T,D,b,LSB,LSBfr,USB,USBfr,SEDfl,SEDfr,x0,y0,h,w,SEDerror,LSBerr,USBerr):
    ...
    leg2=axs[2].legend([USB,LSB,SED],['USB (Nuclear: not fitted)','LSB (Nuclear: not fitted)','Archival data (entire galaxy)'],prop={'size':10},frameon=False,loc='lower right')
    ...
    plt.savefig('ThermalSED.png',bbox_inches='tight')
